...
/*
  ...
  vezes. Todo o movimento contínuo (Aranha, Bandeirinhas, Lanterna,
  BandeiraNegra) consulta isto e pára quando o separador está em segundo
  plano — regra 4 do §7 do plano: animações em loop não devem comer bateria
  com a aba escondida.
*/
