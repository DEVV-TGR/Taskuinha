...
components/decor/  a camada de tralha — aranha, barris, lanternas, caveiras…
...
reage ao rato e ao scroll, e as portadas de madeira que fecham e abrem a cada
navegação entre páginas. Tudo colapsa com `prefers-reduced-motion` e o
conteúdo continua visível sem JavaScript.
